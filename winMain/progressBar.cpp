...
HRESULT progressBar::init( int x, int y, int width, int height )
{
	...
	_progressBarForward = IMAGEMANAGER->addImage( "barForward", "image/Hero/frontHp.bmp", x, y, width, height, false, false);
	_progressBarBack = IMAGEMANAGER->addImage( "barBack", "image/Hero/backHp.bmp", x, y, width, height, false, false);
